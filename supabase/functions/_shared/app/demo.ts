...
export const DEMO_USERS = [
  ...
  { id: "00000000-0000-4000-8000-00000000c0c0", email: "rita@harbor.test", legalName: "Rita Review", role: "customer" as const },
  { id: "00000000-0000-4000-8000-00000000d0d0", email: "oleg@harbor.test", legalName: "Oleg Embargo", role: "customer" as const },
  { id: "00000000-0000-4000-8000-00000000e0e0", email: "nia@harbor.test", legalName: "Nia New", role: "customer" as const },
  { id: "00000000-0000-4000-8000-00000000ad00", email: "admin@harbor.test", legalName: "Ada Admin", role: "admin" as const },
  { id: "00000000-0000-4000-8000-00000000ae00", email: "agent@harbor.test", legalName: "Sam Support", role: "support_agent" as const },
];
